...
namespace Hian.Extensions
{
    public static class Vector3Extensions
    {
        ...
        /// <summary>
        /// 벡터의 지정된 축에 값을 설정합니다.
        /// 이 메서드는 새로운 Vector3를 반환하며, 원래의 Vector3는 변경되지 않습니다 (불변성).
        /// </summary>
        ...
        {
            return new(x, vector.x, vector.y, vector.z);
        }
        ...
        {
            return new(vector.x, y, vector.y, vector.z);
        }
        ...
        {
            return new(vector.x, vector.y, z, vector.z);
        }
        ...
        {
            return vector.x.Approx(vector.y) && vector.y.Approx(vector.z);
        }
        ...
        {
            return RandomDeflected(direction, new Vector2(angle, angle), Vector3.up);
        }
        ...
        {
            return RandomDeflected(direction, new Vector2(angle, angle), up);
        }
        ...
        {
            return RandomDeflected(direction, new Vector2(angleX, angleY), Vector3.up);
        }
        ...
        {
            return RandomDeflected(direction, new Vector2(angleX, angleY), up);
        }
        ...
        {
            return RandomDeflected(direction, angles, Vector3.up);
        }
        ...
        {
            Vector2 randomAngles = Random.insideUnitCircle;
